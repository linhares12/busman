...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        Validator::extend('repeatRelease', function($attribute, $value){
            $states = [
                'only', 'future', 'all'
            ];
        ...
        Validator::extend('categoryType', function($attribute, $value){
            $states = [
                'receipt', 'expense'
            ];
        ...
        Validator::extend('brStates', function($attribute, $value){
            $states = [
        ...
        Validator::extend('userStatus', function($attribute, $value){
            $validStatus = [
                'active',
                'disabled'
            ];

            for($i = 0; $i < count($validStatus); $i++){
                if($value == $validStatus[$i]){
                    return true;
                }
            }
        ...
        Validator::extend('releaseRecurrence', function($attribute, $value){
            $validStatus = [
                'unique',
                'fixed',
                'installment'
